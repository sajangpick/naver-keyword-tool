...
-- 파일: database/schem../기능/admin/admin-roles.sql

-- 2. 구독 및 청구 시스템 (subscription-billing.sql)
-- 파일: database/schem../기능/subscription/subscription-billing.sql

-- 3. 토큰 시스템 (subscription-token-system.sql)
-- 파일: database/schem../기능/subscription/subscription-token-system.sql
```

**실행 방법:**

1. `database/schem../기능/admin/admin-roles.sql` 파일 내용 복사
