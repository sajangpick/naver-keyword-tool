...
#### 1. **데이터베이스 설계** ✅
- 📁 위치: `database/schem../기능/policy-support/policy-support-schema.sql`
- 3개 핵심 테이블 생성
...
database/schem../기능/policy-support/policy-support-schema.sql
```
...
#### 🗄️ 데이터베이스
- **스키마**: `/database/schem../기능/policy-support/policy-support-schema.sql`
- **샘플 데이터**: `/database/schem../기능/policy-support/sample-data.sql`

#### 📚 문서
- **통합 시스템 문서**: `/docs/정책지원금/정책지원금_통합문서.md`
