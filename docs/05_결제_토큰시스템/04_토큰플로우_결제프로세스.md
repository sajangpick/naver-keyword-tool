...
```bash
# 💾 데이터베이스 (2개)
✅ database/schem../01_기능_사용설명서/subscription/subscription-token-system.sql  # 10개 테이블 정의
...
# 📚 문서 (1개)
✅ admin/docs/04_토큰플로우_결제프로세스.md          # 이 문서
```
...
# BASE_URL=https://sajangpick.co.kr
```
...
{
  "action": "applyBonusTokens",  // 또는 "applyDiscount"
...
- 문서 위치: `/admin/docs/04_토큰플로우_결제프로세스.md`
- 관련 파일: `/database/schem../01_기능_사용설명서/subscription/`
...
/database/schem../01_기능_사용설명서/subscription/
