...
> 담당: AI Assistant  
> 위치: `/docs/06_지원금_정책안내/01_정책지원금_6가지안내.md`
...
#### 1. **데이터베이스 설계** ✅
- 📁 위치: `database/schem../01_기능_사용설명서/policy-support/policy-support-schema.sql`
- 3개 핵심 테이블 생성
...
database/schem../01_기능_사용설명서/policy-support/policy-support-schema.sql
```
...
#### 🗄️ 데이터베이스
- **스키마**: `/database/schem../01_기능_사용설명서/policy-support/policy-support-schema.sql`
- **샘플 데이터**: `/database/schem../01_기능_사용설명서/policy-support/sample-data.sql`

#### 📚 문서
- **통합 시스템 문서**: `/docs/06_지원금_정책안내/01_정책지원금_6가지안내.md`
