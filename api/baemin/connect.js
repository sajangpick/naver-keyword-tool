...
function extractStoreIdFromUrl(url) {
  try {
    ...
    // 배달의민족 URL 패턴 분석
    // 예: https://ceo.baemin.com/dashboard?storeId=12345
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    res.json({
      ...
      message: '배달의민족 연동이 완료되었습니다. 리뷰는 10분마다 자동으로 수집됩니다.'
    });

  } catch (error) {
    console.error('[배달의민족 연동] 오류:', error);
