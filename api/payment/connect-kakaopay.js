...
module.exports = async (req, res) => {
  ...
  try {
    ...
    return res.json({
      ...
      redirectUrl: `https://kakaopay.com/payment/billing/authorize?customerKey=${userId}`,
      note: '실제 연동을 위해서는 카카오페이 API 키 설정이 필요합니다'
    });
    ...
    return res.status(500).json({
      success: false,
      error: error.message || '카카오페이 연동 중 오류가 발생했습니다'
    });
  }
};
